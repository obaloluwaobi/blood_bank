...
import 'package:blood_bank/Dashboard/Signup/Forget_Password_Reset.dart';
...
class Forget_password_otp extends StatefulWidget {
  const Forget_password_otp({Key? key}) : super(key: key);

  @override
  State<Forget_password_otp> createState() => _Forget_password_otpState();
}
      ...
      body: Container(
        ...
        child: Column(
          ...
          OTPTextField(
            ...
            ElevatedButton(onPressed: ()=>Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> New_password())),
